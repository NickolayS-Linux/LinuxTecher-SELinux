...
<img width="727" height="757" alt="image" src="https://github.com/user-attachments/assets/011ed011-5040-4338-9f2a-3cfa6de1ca1a" />

Видим, что изменения применились и команды отрабатывают корректно

Попробуем перезагрузить хосты и ещё раз сделать запрос с помощью dig:

<img width="727" height="528" alt="image" src="https://github.com/user-attachments/assets/965ee5e6-f58c-4dcf-8b03-bf4451f47ad3" />

Всё правильно. После перезагрузки настройки сохранились. 

Важно **понимать**, что мы не добавили новые правила в политику для назначения этого контекста в каталоге. 
...
<img width="1175" height="315" alt="image" src="https://github.com/user-attachments/assets/b416cf3d-552f-42cb-b147-9ac9dad193be" />
